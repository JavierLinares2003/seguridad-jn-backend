...
return new class extends Migration
{
     ...
     * Run the migrations.
     *
     * Modifica el trigger validar_requisitos_puesto para que NO re-valide
     * en UPDATE (ej. finalizar asignación). Solo valida en INSERT.
     */
    public function up(): void
    {
        DB::unprepared("
            ...
            BEGIN
                -- Solo validar en INSERT; los UPDATEs (finalizar, suspender, etc.) pasan sin re-validar
     ...
     *
     * No-op intencional: revertir requeriría recrear la función anterior,
     * pero el cambio es solo aditivo (añade early return en UPDATE).
     */
