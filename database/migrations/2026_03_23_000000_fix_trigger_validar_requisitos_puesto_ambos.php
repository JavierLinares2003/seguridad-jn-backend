...
{
    /**
     * Re-aplica la función validar_requisitos_puesto() con soporte para sexo "Ambos".
     *
     * Esta migración es idempotente (CREATE OR REPLACE). Existe porque la migración
     * 2026_02_13_205029_add_ambos_sexo_validation_to_triggers no se aplicó en producción,
     * causando que asignaciones con puestos configurados en "Ambos" fallaran con:
     * "El sexo no coincide con el requerido para el puesto"
     */
    ...
    /**
     * No se revierte — regresar al trigger sin soporte "Ambos" rompería asignaciones existentes.
     */
    public function down(): void
    {
        // No-op intencional: revertir introduciría el bug original.
    }
};
