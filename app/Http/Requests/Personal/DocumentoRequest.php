...
class DocumentoRequest extends FormRequest
{
    ...
    {
        $rules = [
            'tipo_documento_personal_id' => ['required', 'exists:tipos_documentos_personal,id'],
    ...
    {
        return [
            'tipo_documento_personal_id.required' => 'El tipo de documento es obligatorio.',
            'tipo_documento_personal_id.exists' => 'El tipo de documento seleccionado no existe.',
    ...
    public function withValidator(Validator $validator): void
    {
        $validator->after(function ($validator) {
            $tipoDocumentoId = $this->tipo_documento_personal_id;

            if ($tipoDocumentoId && $this->hasFile('archivo')) {
                $tipoDocumento = TipoDocumentoPersonal::find($tipoDocumentoId);
