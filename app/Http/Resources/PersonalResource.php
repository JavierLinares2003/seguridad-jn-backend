    ...
    public function toArray(Request $request): array
    {
        ...
        return [
            ...
            'tallas' => $this->whenLoaded('talla', fn () => [
                ...
                'talla_pantalon' => $this->talla?->talla_pantalon,
                'talla_zapato' => $this->talla?->talla_zapato,
                'talla_chaleco' => $this->talla?->talla_chaleco,
                'talla_gorra' => $this->talla?->talla_gorra,
                'genero_preferido' => $this->talla?->genero_preferido,
            ]),
